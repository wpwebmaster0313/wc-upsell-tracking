...
/**
 * Handles general AJAX queries for checkout popup
 * 
 * @author WC Bessinger <dev@silverbackdev.co.za>
 */
add_action( 'wp_ajax_uv2_co_popup_general', 'uv2_co_popup_general' );
add_action( 'wp_ajax_nopriv_uv2_co_popup_general', 'uv2_co_popup_general' );

function uv2_co_popup_general() {

    check_ajax_referer( 'checkout popup general js' );
