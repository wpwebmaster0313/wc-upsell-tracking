...
/**
 * General product upsell ajax to retrieve variation ids, images etc
 * 
 * @author WC Bessinger <dev@silverbackdev.co.za>
 */
add_action( 'wp_ajax_uv2_upsell_general', 'uv2_upsell_general' );
add_action( 'wp_ajax_nopriv_uv2_upsell_general', 'uv2_upsell_general' );

function uv2_upsell_general() {

    check_ajax_referer( 'product upsell general js' );
