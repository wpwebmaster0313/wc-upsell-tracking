...
/**
 * Handles general AJAX requests for mini cart addons
 * 
 * @author WC Bessinger <dev@silverbackdev.co.za>
 */
add_action( 'wp_ajax_uv2_minicart_general', 'uv2_minicart_general' );
add_action( 'wp_ajax_nopriv_uv2_minicart_general', 'uv2_minicart_general' );

function uv2_minicart_general() {

    check_ajax_referer( 'minicart general js' );
