...
function upsell_v2_cart_addon_product_info_modal($upsell_id) {
    ...
    <div id="product-data-<?php echo $upsell_id; ?>" class="upsell-v2-cart-addon-modal-outer-cont mfp-hide white-popup-block">
        ...
        <div class="upsell-v2-cart-addon-product-data-modal-inner-cont row">
            ...
            <div class="upsell-v2-cart-upsell-modal-header-cont small-12">
            ...
            <!-- images -->
            <div class="upsell-v2-cart-addon-product-data-modal-images-cont small-12 medium-6 w-50">
                <div class="row">
                    <?php
                    $img_counter = 0;
                    foreach ( $gall_img_ids as $img_id ) :
                        ...
                        if ( $img_counter === 0 ) :
                            ...
                            <!-- large image top -->
                            <div class="upsell-v2-cart-addon-modal-img-big small-12">
                                <img src="" alt="<?php echo $prod_title; ?>">
                            </div>
                        <?php else : ?>
                            <!-- small images bottom -->
                            <div class="upsell-v2-cart-addon-modal-img-small small-2" title="<?php _e( 'Click to view', 'woocommerce' ); ?>">
            ...
            <!-- description -->
            <div class="upsell-v2-cart-addon-product-data-modal-description-cont small-12 medium-6 w-50">
                <?php echo $short_descr; ?>
            </div>

            <!-- add to cart -->
            <div class="upsell-v2-cart-addon-modal-button-cont" class="small-12">
