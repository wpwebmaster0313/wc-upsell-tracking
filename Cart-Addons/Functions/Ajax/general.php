...
/**
 * Handles general AJAX queries for Cart Addons
 * 
 * @author WC Bessinger <dev@silverbackdev.co.za>
 */
add_action( 'wp_ajax_uv2_cart_addons_general', 'uv2_cart_addons_general' );
add_action( 'wp_ajax_nopriv_uv2_cart_addons_general', 'uv2_cart_addons_general' );

function uv2_cart_addons_general() {

    check_ajax_referer( 'cart addons general js' );
